import type { DispersionMessageNotificationCommand } from '../../notifications/application/use-cases/send-dispersion-message-notification.use-case';
...
export function buildDispersionMessageNotificationPayload(input: {
...
}): DispersionMessageNotificationCommand {
