...
export class ValidateTripLodgingExpenseDto {
  @Type(() => Number)
  ...
  @Type(() => Number)
  @IsNumber({}, { message: 'El monto de hospedaje debe ser numérico.' })
  @Min(0, { message: 'El monto de hospedaje no puede ser negativo.' })
  hospedaje: number;
}
